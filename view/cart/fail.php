					...
					<div class="tt-col-right tt-col-objects">
						...
						<div class="tt-col__item">
							<div class="tt-obj tt-obj-cart js-dropdown-cart">
								<a href="index.php" class="tt-obj__btn cart-contents">
		...
		<div class="container container-fluid-xl">
			<div class="tt-breadcrumbs">
				<span><span><a href="../index.php">Home</a> / <span class="breadcrumb_last"
							aria-current="page">Order Failed</span></span></span>
			</div>
			...
			<div class="lazyload subpage-bg-right subpage-bg__position0" data-bg="">
				<div class="container container-fluid-lg">
					...
					<div class="col-sm-10 offset-sm-1 text-center">
						<p class="icon-addcart" ><span><img src="../../images/cross.png" style="width: 300px;"></span></p>
						
						<br>
						<h2 class="mb-4">Transaction Failed!</h2>
						<p><a class="btn btn-invert alt wc-backward" href="../dash/subscriptions.php" > View Orders</a>
