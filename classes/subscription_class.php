...
{
	//--INSERT--//
	public function add_subscription($name,$price,$bagno,$description)
	{
		$sql="INSERT INTO `subscription`( `subscription_name`, `subscription_price`, `bag_number`, `Decription`) VALUES ('$name','$price','$bagno','$description')";
