    ...
    <tr>
      ...
      <td>
        <div class="inner" style="padding-left: 30px;">
          <h2><?php echo $result[$i]['sub_name'];  ?></h2>
          <figure><i class="lni-map-marker"></i> <?php echo $result[$i]['pickups'];  ?></figure>
        </div>
      </td>
      ...
      <td style="padding-left: 5px;">
        <?php echo $result[$i]['order_status'];  ?>
      </td>
    </tr>
      ...
      <tr>
        ...
        <td>
          <div class="inner" style="padding-left: 10px;">
            <h2><?php echo $result[$i]['wash_name'];  ?></h2>
          </div>
        </td>
        <td><?php echo $result[$i]['order_date'];  ?></td>
           <td><?php echo $result[$i]['invoice_no'];  ?></td>
